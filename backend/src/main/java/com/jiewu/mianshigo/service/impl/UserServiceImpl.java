...
import static com.jiewu.mianshigo.constant.UserConstant.USER_LOGIN_STATE;

import cn.hutool.core.collection.CollUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.jiewu.mianshigo.common.ErrorCode;
import com.jiewu.mianshigo.constant.RedisConstant;
import com.jiewu.mianshigo.mapper.UserMapper;
import com.jiewu.mianshigo.model.dto.user.UserQueryRequest;
import com.jiewu.mianshigo.model.entity.User;
import com.jiewu.mianshigo.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "jiewu";
    ...
    public List<Integer> getUserSignInRecord(long userId, Integer year) {
        ...
        // 从索引 0 开始查找下一个被设置为 1 的索引 (使用 nextSetBit 方法)
