...
import com.jiewu.mianshigo.mapper.QuestionBankQuestionMapper;
...
*/
        ...
        validQuestionIdList = validQuestionIdList.stream().filter(
                questionId -> !existQuestionIdSet.contains(questionId)).collect(Collectors.toList());
